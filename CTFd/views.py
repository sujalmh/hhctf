...
def setup():
    ...
    if not config.is_setup():
        ...
        if request.method == "POST":
            ...
            # Upload banner
            default_ctf_banner_location = url_for("views.themes", path="img/font-title.png")
    ...
    <div class="col-md-6 offset-md-3 banner-box">
        <img class="w-100 mx-auto d-block" style="max-width: 600px;padding: 50px;" src="{default_ctf_banner_location}" />
        <h3 class="text-center">
            <p>In the ruins of a digital world, a new challenge awaits. Can you crack the code and survive?</p>
            <p>Follow us on social media:</p>
            <a href="https://www.instagram.com/crypton.mite/"><i class="fab fa-instagram fa-2x" aria-hidden="true"></i></a>
        </h3>
        <br>
